	...
	*/
	...
	public <T> T getProxy(Class<T> interfaceClass) {
		...
		if(agent == null)
		{
			...
			{
				com.scaleton.dfinity.agent.annotations.Agent agentAnnotation = interfaceClass.getAnnotation(com.scaleton.dfinity.agent.annotations.Agent.class);
			...
			if (method.isAnnotationPresent(QUERY.class) || method.isAnnotationPresent(UPDATE.class)) {			
				...
				case UPDATE: {
					UpdateBuilder updateBuilder = UpdateBuilder
							.create(this.agent, this.canisterId, methodName);
					...
					if(waiter == null)
					{
						...
						{
							com.scaleton.dfinity.agent.annotations.Waiter waiterAnnotation = method.getAnnotation(com.scaleton.dfinity.agent.annotations.Waiter.class);
